                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('nivel_experiencia') is-invalid @enderror" 
                                    ...
                                    @foreach($nivelesExperiencia as $key => $value)
                                        <option value="{{ $key }}" {{ old('nivel_experiencia') == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('modalidad_trabajo') is-invalid @enderror" 
                                    ...
                                    @foreach($modalidadesTrabajo as $key => $value)
                                        <option value="{{ $key }}" {{ old('modalidad_trabajo') == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('salario_max') is-invalid @enderror" 
                                           id="salario_max" name="salario_max" value="{{ old('salario_max') }}" step="0.01"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       id="beneficio_{{ $key }}"
                                                       {{ (is_array(old('beneficios')) && in_array($key, old('beneficios'))) ? 'checked' : '' }}>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                          ...
                                          placeholder="Describe las responsabilidades y funciones principales del puesto...">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('requisitos') is-invalid @enderror" 
                                          ...
                                          placeholder="Especifica la formación, experiencia y habilidades necesarias...">{{ old('requisitos') }}</textarea>
                                @error('requisitos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">
