        ...
        <div class="row">
            ...
            <div class="col main-content">
                ...
                <div class="header mb-4 rounded shadow-sm d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 fw-bold">Crear Nueva Oferta</h4>
                ...
                <div class="container">
                    <form action="{{ route('ofertas.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="salario" id="salario" class="form-control" value="{{ old('salario') }}">
                            @error('salario')<div class="text-danger">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                            <label for="tipo_contrato" class="form-label">Tipo de Contrato</label>
                            <input type="text" name="tipo_contrato" id="tipo_contrato" class="form-control" value="{{ old('tipo_contrato') }}" required>
