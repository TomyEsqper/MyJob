    ...
    <div class="col-md-5 col-12 p-4 bg-light">
        <div class="container-der-login" style="display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; margin-bottom:0">
            ...
            <div style="display: flex; align-items: center; gap: 10px; margin-top: 5%;">
                <a href="#" id="btn-google" data-base-url="{{ route('google.redirect') }}" class="google-btn">
            ...
            <form id="formulario-registro" method="POST" action="{{ route('register') }}">
                ...
                <div id="inputs-usuario" class="inputs-usuario" style="display: block;">
                    <label class="label">
                        ...
                        <input type="text" class="input" name="name" id="name_usuario" placeholder="Ingrese su nombre completo" autocomplete="off" data-required="true" required/>
                    </label>
                    ...
                    <div class="password-field">
                        <label class="label">
                            <input type="password" id="password_usuario" name="password" class="input" placeholder="Ingrese su contraseña" data-required="true" required/>
                            <button type="button" class="toggle-password" data-target="password_usuario" aria-label="Mostrar u ocultar contraseña">Mostrar</button>
                        </label>
                        <div class="password-rules">
                            <div class="rule" data-rule="uppercase">Mayúscula (A-Z)</div>
                            <div class="rule" data-rule="lowercase">Minúscula (a-z)</div>
                            <div class="rule" data-rule="number">Número (0-9)</div>
                            <div class="rule" data-rule="special">Caracteres especiales (@, ., #, etc)</div>
                            <div class="rule" data-rule="length">Mínimo 8 caracteres</div>
                        </div>
                    </div>
                    ...
                    <label class="label">
                        ...
                        <button type="button" class="toggle-password" data-target="password_confirmation_usuario" aria-label="Mostrar u ocultar contraseña">Mostrar</button>
                    </label>
                </div>
                ...
                <div id="inputs-empresa" class="inputs-empresa" style="display: none;">
                    ...
                    <label class="label">
                        <span class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.57 19.57 0 0 1-6-6 A19.79 19.79 0 0 1 2 4.18 2 2 0 0 1 4 2h3 a2 2 0 0 1 2 1.72 c.12.81.36 1.6.72 2.34 a2 2 0 0 1-.45 2.11 L8.09 8.91 a16 16 0 0 0 6 6 l1.17-1.17 a2 2 0 0 1 2.11-.45 c.74.36 1.53.6 2.34.72 A2 2 0 0 1 22 16.92z"/>
                          </svg>
                        </span>
                    ...
                    <div class="inputs-empresa-inline">
                        ...
                        <div class="password-field">
                            <label class="label">
                                <input type="password" id="password_empresa" name="password_empresa" class="input" placeholder="Ingrese su contraseña" data-required="true" required/>
                                <button type="button" class="toggle-password" data-target="password_empresa" aria-label="Mostrar u ocultar contraseña">Mostrar</button>
                            </label>
                            <div class="password-rules">
                        ...
                        <label class="label">
                            ...
                            <button type="button" class="toggle-password" data-target="password_confirmation_empresa" aria-label="Mostrar u ocultar contraseña">Mostrar</button>
                        </label>
                    </div>
                </div>
