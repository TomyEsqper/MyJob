    ...
    <div class="row">
        ...
        <div class="col-md-5 col-12" style="padding: 4%; background-color: #f8f9fa;">
            <div class="container-der-login" style="display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; margin-bottom:0%">
                ...
                <h6>Inicie sesión para acceder a las oportunidades laborales que mejor se adapten a su perfil.</h6>       
            ...
            <div class="container-der-login-formulario" style="margin-bottom: 20%;">
                <form action="">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <p style="margin-top: 3%">¿Haz olvidado tu contraseña?<a href="#" class="enlaces-etiqueta-a" style="text-decoration: none;"> Haz click aquí</a></p>
                    </div>
                </form>
            </div>
            <div class="container-der-login-registro"">
                <p>¿No tienes una cuenta? <a href="#" class="enlaces-etiqueta-a" style="text-decoration: none;">Regístrate</a></p>
            </div>
        </div>
    </div>  
</body>
