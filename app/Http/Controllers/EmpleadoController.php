...
class EmpleadoController extends Controller
{
    ...
    public function actualizarPerfil(Request $request, $id)
    {
        $request->validate([
            ...
            'facebook.url' => 'La URL de Facebook debe ser válida (ejemplo: https://facebook.com/usuario).',
            'instagram.max' => 'El Instagram no puede superar 100 caracteres.',
            'instagram.url' => 'La URL de Instagram debe ser válida (ejemplo: https://instagram.com/usuario).',
            'linkedin.max' => 'El LinkedIn no puede superar 100 caracteres.',
            'linkedin.url' => 'La URL de LinkedIn debe ser válida (ejemplo: https://linkedin.com/in/usuario).',
